            ...
            <div id="participants-box">
                        ...
                        <form action="api.php" method="post" name="create-participants-form" id="create-participants-form" onsubmit="return add_participants()">
                            ...
                            <div class="row">
                                <div class="col-lg-12 text-right">
                                    <button type="submit" class="btn btn-primary">ADD PARTICIPANT&nbsp;&nbsp;&nbsp;<i class="fa fa-plus"></i></button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="row mt-5 m-4">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <input type="text" id="search_bar" onkeyup="search()" class="form-control" placeholder="Search for names..">
                        </div>
